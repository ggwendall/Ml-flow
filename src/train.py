...
mlflow.set_tracking_uri("file:///Users/gwenq/Documents/Exo_Amine/mlflow-main/mlruns")

# Load data
data = pd.read_csv("C:/Users/gwenq/Documents/Exo_Amine/mlflow-main/data/aug_train.csv")
targets = data[["target"]]
...
for n_estimators in tqdm(n_estimators_range):
    for max_depth in tqdm(max_depth_range, leave=False):
        for max_features in tqdm(max_features_range, leave=False):
            ...
            with mlflow.start_run(experiment_id=int(experiment_id)):
